...
const CartHome = (props) => 
{
  ...
  <Link  to='/singleproduct' state={item}> 
    <img class=" rounded-t-lg object-cover max-h-80" src={images} alt="product image" />
  </Link>
  ...
  <div class="mt-4 px-5 pb-5">
      ...
      <h5 class="text-xl font-semibold tracking-tight text-slate-900">BRAND:{item.brand.toUpperCase()}</h5>
    ...
    <div class="flex items-center justify-between">
      <p>
        <span class="text-2xl font-bold text-slate-900">${item.price-item.discount}</span>
        <span class="text-sm text-slate-900 line-through">${item.price}</span>
      </p>
      <button onClick={addingToCart}  class="flex items-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
