...
const Winter = () => {
  ...
  const handleClick =async () => {
    const res=await fetch('/api/v1/product/getByCategoryName/winter',{
      method:"GET",
      headers:{
  ...
  return (
    ...
    <div class="m-4 mx-4 max-w-screen-lg overflow-hidden rounded-xl border shadow-lg md:pl-8">
      <div class="flex flex-col overflow-hidden bg-white sm:flex-row md:h-80">
        <div class="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-3/5">
          ...
          <button onClick={handleClick} class="group mt-auto flex w-44 cursor-pointer select-none items-center justify-center rounded-md bg-black px-6 py-2 text-white transition">
