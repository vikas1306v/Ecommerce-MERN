    ...
    <div class="relative">
      <ul class="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
        <li class="flex items-center space-x-3 text-left sm:space-x-4">
          <button onClick={()=>navigate('/productslandingpage')} class="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-200 text-xs font-semibold text-emerald-700" href="#"
  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
...

     {
      ...
      <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src={item.images[0].url} alt="" />
    ...
    <div class="">
      ...
      <div class="mt-6 border-t border-b py-2">
        <div class="flex items-center justify-between">
          ...
          <p class="font-semibold text-gray-900">{cart.cartTotal} USD</p>
        </div>
        <div class="flex items-center justify-between">
          <p class="text-sm font-medium text-gray-900">Shipping</p>
          <p class="font-semibold text-gray-900">{`4.99$`} </p>
        </div>
      </div>
      <div class="mt-6 flex items-center justify-between">
        <p class="text-sm font-medium text-gray-900">Total</p>
        <p class="text-2xl font-semibold text-gray-900">{cart.cartTotal+4.99} USD</p>
      </div>
    </div>
    <div class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">
    {
    user.token==''?null:<Paypal  totalPrice={cart.cartTotal+4.99}/>}  
    </div>
  </div>
</div>
